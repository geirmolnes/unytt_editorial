<!-- Editorial constitution for unytt newsroom tools.
     Each block is delimited by an HTML-comment marker giving its machine
     name (exposed as the ed.<NAME> constant). Edit the prose freely; keep
     the markers and their names. -->
